...
A local dashboard for open stock positions. Add ticker, purchase date, shares, and cost basis, then refresh prices to see current value, 21-day EMA, and unrealized gain or loss.
